...
# Exact, user-authorized terminal-result call-chain evolution. Historical
# hashes below remain pinned; replay, networks and import checks are unchanged.
REVIEWED_COLLISION_EVOLUTIONS = {
    "core/env/uav_env.py": {
    ...
    "chapter3_bser/experiments/phase1c_bser_rmaddpg_v2/training_env.py": {
        "historical_sha256": "20378574acc6b3acbcba6a9359bc74021b1ff152a728ba5b015f2f13d1544cb2",
        "current_sha256": "b5b5e46d17e457eea844d709350bd4fbf9b279081f3cad390feedab72fc56ce9",
    },
}
    ...
    def test_frozen_files_hashes_and_import_direction(self):
        ...
        for relative, expected in hashes.items():
            ...
            if relative in REVIEWED_COLLISION_EVOLUTIONS:
                ...
                expected = reviewed["current_sha256"]
            self.assertTrue(
